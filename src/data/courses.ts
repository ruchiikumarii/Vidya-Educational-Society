...
export const courses: Course[] = [
  ...
  },
  {
    id: "c3",
    slug: "oc-cip",
    title: "OC-CIP (OKCL Certificate in Information Proficiency)",
    shortTitle: "OC-CIP",
    ...
    careerOpportunities:
      "Computer Operator, Data Entry Operator, and eligibility for the advanced OC-CIP (A) programme.",
    certification: "Certified by Odisha State Open University (OSOU), Sambalpur"
  },
  {
    id: "c4",
    slug: "oc-cip-a",
    title: "OC-CIP (A) - Advanced Skill Module",
    shortTitle: "OC-CIP (A)",
    category: "Skill Development",
    duration: "3 Months",
    eligibility: "OC-CIP",
    ...
    careerOpportunities:
      "Specialised skill certification in your chosen stream, plus eligibility for the two-course OC-CIP (A) programme.",
    certification: "OKCL / OSOU Skill Certificate"
  },
  {
    id: "c5",
    slug: "oc-cip-a-dual",
    title: "OC-CIP (A) - Dual Skill Programme (2 of 37)",
    shortTitle: "OC-CIP (A) Dual",
    category: "Skill Development",
    duration: "6 Months",
    eligibility: "OC-CIP (A)",
    fees: "₹9,000",
    mode: "Online / Offline",
    affiliation: "OKCL, Bhubaneswar (Govt. of Odisha)",
    batchTiming: COMMON_TIMING,
